...
The progress score $s$ is an exponential moving average of the PSNR progress:
\begin{align}
...
\begin{table}[h]
  ...
  \begin{figure}
		\includegraphics{bicycle-ref2}
	\includegraphics{bicycle-calib2}
	\caption{Reference (top) vs ours (bottom) on bicycle view.}
	\label{img:quali1}
\end{figure}

\begin{figure}
  \includegraphics[width=8cm]{drjohnson-flow-img.png}
\caption{Reference (left) vs ours (right) on DrJohnson view. The bottom row shows the motion flow estimated with RAFT \cite{DBLP:journals/corr/abs-2003-12039}}
\label{img:quali2}
\end{figure}

\begin{figure}
  \includegraphics[width=8cm]{drjohnson-flow-hist.png}
...
\begin{table}[h]
	...
	\begin{tabular}{|p{2cm}|c|c|c|c|}
				...
				\hline
				bicycle & 25.81 & 25.74 & 25.82 & \textbf{26.34} \\
				bonsai & 32.31 & 32.15 & 32.41 & \textbf{32.72} \\
				counter & 29.04 & 29.09 & 29.13 & \textbf{29.26} \\
				garden & 27.70 & 27.50 & 27.72 & \textbf{28.32} \\
				kitchen & 31.12 & 31.07 & 30.71 & \textbf{31.14} \\
				room & 31.75 & 31.77 & 31.80 & \textbf{31.94} \\
				stump & 26.72 & 26.60 & 26.73 & \textbf{27.28} \\
				Train & 22.47 & 22.31 & 22.54 & \textbf{22.61} \\
				Truck & 26.13 & 26.05 & 26.11 & \textbf{26.18} \\
				DrJohnson & 29.93 & 29.55 & 29.81 & \textbf{30.12} \\
				Playroom & 30.61 & 30.36 & 30.45 & \textbf{30.77} \\
        \hline
        Average & 28.51 & 28.38 & 28.48 & \textbf{28.79} \\
        \hline
			\end{tabular}
	}
	\caption{Ablation: PSNR [dB] with some of the solution missing. Scenes bicycle, bonsai, counter, garden, kitchen, room and stump
  are from Mip-nerf 360 \cite{barron2022mip}, Train and Truck are from Tanks and temples \cite{knapitsch2017tanks}, DrJohnson and
  Playroom are from Deep Blending \cite{HPPFDB18}.}
